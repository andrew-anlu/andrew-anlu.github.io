 ...
 * [charts](https://github.com/danielgindi/Charts)国外人写有各种效果的图表，非常强大
 * [xypieChart](https://github.com/xyfeng/XYPieChart)带有动画效果的饼状图
 * [chartee](https://github.com/zhiyu/chartee)股票K线图示例
 * [stockChart](https://github.com/dangfm/stockChart)股票K线图示例
 * [HYStockChart](https://github.com/NunchakusHuang/HYStockChart)股票图
 * [YKLineChartView](https://github.com/chenyk0317/YKLineChartView)iOS 股票的K线图 分时图 Kline http://chenyk.com
 * [LPLineChartView](https://github.com/xiaofei86/LPLineChartView)不错的图形报表
 * [BBStockCharView](https://github.com/chenxiaoyu3/BBStockChartView)A full customizable iOS stock chart view, K-Line, volume graph, with gesture supported.
 * [SwiftCharts](https://github.com/i-schuetz/SwiftCharts) Easy to use and highly customizable charts library for iOS
 * [drawLineChart](https://github.com/q946666800/DrawLineChart)绘制简单折线图
 * [MCChartview](https://github.com/zhmch0329/MCChartView)MCChartView is some different charts used in my project! Bar, Line, Pie, Radar, Circle and Coverage chart views.
 * [UUChartView](Line and Bar of Chart, you can mark the range of value you want, and show the max or min values in linechart with the form style)
 * [Zcharts](https://github.com/zhuayi/ZCharts)ZCharts 是一个图表库， 能够很简单便捷的为应用程序添加有交互性的图表
